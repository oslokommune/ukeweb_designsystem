...
To aid in development of these patterns, clone the repository 'styleguide_devtools' and run `docker-compose up` and point your browser to `localhost:9000`.
...
See the repository postfixed with '\_example' for different ways of consuming the patterns. Some of the example repository will show how to consume the twig files as well as the sass files directly, compiling the twig files either with javascript or PHP.
