...
- Use CSS for menu footer separator instead of pipe character.

## [4.0.3] - 2026-07-02

### Added

- Added documentation in fieldset about use of aria-required.
- Added background color to global styles.
...
- Added keyboard focus styles to banner.

### Fixed

- Fix extranous non-emits in projects.

## [4.0.1] - 2026-06-03

### Changed

- Changed contactbox styling to support div tags.
- Changed menu component to new version.
...
- Updated Oslo Sans to version 1.3

### Fixed

- Fix accordion triggers by changing the target.
