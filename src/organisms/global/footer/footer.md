...
| *logos | Object | figures:Object{ link:Object{ url:String, target:String}, img:Object{ alt:String, defaultUrl:String, mediaQueryUrls:Array[Object{ query:String, url:String }] } } | Valid logos | Logos for the right side of the footer |
