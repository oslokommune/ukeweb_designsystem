...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (mapDiv) {
    let map = getMapObject(10.74981, 59.913008, 12.0, "osg-map");
    map.on("load", function () {
      addMarker(map, "one-magic-marker", 10.74981, 59.913008, true, "Heading", "Description");
  ...
  if (mapDiv2) {
    let map = getMapObject(10.74981, 59.913008, 10.0, "osg-map2");
  ...
  if (mapDiv3) {
    let map = getMapObject(10.74981, 59.913008, 10.0, "osg-map3");
    map.on("load", function () {
