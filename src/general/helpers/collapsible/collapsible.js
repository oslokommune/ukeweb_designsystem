...
function handleAnimation(e) {
  if (e.target.classList.contains('ods-animation') && e.target.classList.contains('ods-animation--rotate-change')) {
    e.target.classList.toggle('ods-animation--rotate-change-open');
  }
